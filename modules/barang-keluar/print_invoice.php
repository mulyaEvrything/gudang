...
<table>
  <tr>
    ...
    <table border="1px" style="border-collapse: collapse;" width="100%">
      ...
      <tr>
          <td colspan="3" style="padding-left: 5px;" width="59%" rowspan="2"> Terbilang :<br> <?php $tot = $data['total'] + ($data['total']*0.11); echo ucwords(terbilang($tot)); ?> Rupiah</td>
          <td colspan="2" rowspan="2"> SUB TOTAL <br> PPN <br> TOTAL </td>
          <td rowspan="2" align="right"><?php echo number_format($data['total'],0,',','.'); ?> <br> 
              <?php echo number_format($data['total']*0.11,0,',','.'); ?> <br> 
              <?php 
              echo number_format($data['total']+($data['total']*0.11),0,',','.'); ?></td>
        </tr>
