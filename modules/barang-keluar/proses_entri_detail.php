...
// jika user sudah login, maka jalankan perintah untuk insert
  ...
  if (isset($_POST['simpan'])) {
    ...
    $insert = mysqli_query($mysqli, "INSERT INTO tbl_detail_barang_keluar(id_keluar, id_barang, jumlah, harga) 
    ...
    if ($insert) {
      ...
      header('location: ../../main.php?module=detail_barang_keluar&id='.$id_transaksi.'&pesan=1');
    }
  }
}
