  ...
  if (isset($_GET['pesan'])) {
    ...
    if ($_GET['pesan'] == 1) {
      ...
      echo '<div class="alert alert-notify alert-success alert-dismissible fade show" role="alert">
              ...
              <span data-notify="message">Data Transaksi Barang Masuk berhasil disimpan.</span>
    ...
    elseif ($_GET['pesan'] == 2) {
      ...
      echo '<div class="alert alert-notify alert-success alert-dismissible fade show" role="alert">
              <span data-notify="icon" class="fas fa-check"></span> 
              <span data-notify="title" class="text-success">Sukses!</span> 
              <span data-notify="message">Data Transaksi Barang Masuk berhasil diubah.</span>
              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>';
    ...
    elseif ($_GET['pesan'] == 3) {
      ...
      echo '<div class="alert alert-notify alert-danger alert-dismissible fade show" role="alert">
              ...
              <span data-notify="title" class="text-success">Sukses!</span> 
              <span data-notify="message">Data Transaksi Barang Masuk berhasil dihapus.</span>
              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>';
    ...
    elseif ($_GET['pesan'] == 4) {
      ...
      echo '<div class="alert alert-notify alert-danger alert-dismissible fade show" role="alert">
              ...
              <span data-notify="message">Data Transaksi Barang Masuk tidak bisa dihapus karena sudah tercatat pada Data Transaksi.</span>
              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>';
    ...
    <div class="page-inner py-4">
      <div class="page-header text-white">
        ...
        <ul class="breadcrumbs">
          ...
          <li class="nav-item"><a href="?module=barang_keluar" class="text-white">Barang Masuk</a></li>
          <li class="separator"><i class="flaticon-right-arrow"></i></li>
  ...
  <div class="page-inner mt--5">
    <div class="card">
      <div class="card-header">
        <!-- judul form -->
        <div class="card-title">Entri Data Detail Barang Masuk</div>
      </div>
      <!-- form entri data -->
      <form action="modules/barang-masuk/proses_entri_detail.php" method="post" class="needs-validation" novalidate>
        <div class="card-body">
          <div class="row">
            <div class="col-md-7">
            ...
            <table class="display table table-bordered table-striped table-hover">
              ...
              <tbody>
                ...
                $query = mysqli_query($mysqli, "SELECT * from tbl_detail_barang_masuk dbm
                                                LEFT JOIN tbl_barang b ON b.id_barang = dbm.id_barang
                                                WHERE dbm.id_masuk = '$id_transaksi'")
                                                or die('Ada kesalahan pada query tampil data : ' . mysqli_error($mysqli));
                // ambil data hasil query
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <div>
                      <!-- tombol detail data -->
                      <a href="modules/barang-masuk/proses_hapus_detail.php?id=<?php echo $data['id_masuk']; ?>&id_barang=<?php echo $data['id_barang']; ?>" class="btn btn-icon btn-round btn-danger btn-sm mr-md-1" data-toggle="tooltip" data-placement="top" title="Hapus">
        ...
        <div class="card-action">
          ...
          <a href="?module=barang_masuk" class="btn btn-default btn-round pl-4 pr-4">Kembali</a>
        </div>
      </form>
    </div>
  </div>
