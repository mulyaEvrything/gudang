...
?>
  ...
  <div class="kop">
    <div class="left">
      ...
      <p>Jl. Yogyakarta No. 15 RT.001 RW.006, Loktabat Selatan, Banjar Baru Selatan</p>
      <p>Email: lunasindo_sa@yahoo.com</p>
  ...
  <table border="1">
    ...
    <tbody>
      ...
      FROM tbl_barang_masuk INNER JOIN tbl_barang ON tbl_barang.id_barang = tbl_barang_masuk.barang
      INNER JOIN tbl_satuan ON tbl_satuan.id_satuan = tbl_barang.satuan
      WHERE tbl_barang_masuk.tanggal = (SELECT MAX(tanggal) FROM tbl_barang_masuk)")
